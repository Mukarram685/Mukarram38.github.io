...
const Navbar = () => {
  ...
  return (
    <nav className="md:bg-blue-700 bg-gray-800 text-white p-4 px-5 fixed w-full top-0 shadow-md z-50 overflow-hidden">
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-0 right-0 h-full w-2/3 bg-gray-600 text-white shadow-lg transform transition-transform duration-300 ease-in-out
