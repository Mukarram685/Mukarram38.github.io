...
import { FaWhatsapp, FaPhoneAlt, FaLinkedin, FaEnvelope, FaGithub } from "react-icons/fa";
  ...
  return (
    <section id="contact" className="bg-[#1A1A1A] text-white px-4 py-12">
      ...
      <div className="max-w-6xl mx-auto mt-10 flex flex-col md:flex-row gap-10">
        ...
        <div className="flex-1 md:max-w-md bg-gray-900 bg-opacity-80 border border-gray-700 rounded-2xl shadow-xl p-6 backdrop-blur-lg">
          <h2 className="text-[#007BFF] text-2xl font-bold mb-6 text-center">Get in Touch</h2>
          ...
          <div className="space-y-6">
            ...
            <a
              ...
              className="flex items-center gap-4 bg-gray-800 hover:bg-[#007BFF] transition px-2 md:px-5 py-3 rounded-lg shadow-md"
            >
              <FaWhatsapp className="text-green-500 text-2xl" />
              <span className="text-lg font-sm text-white">WhatsApp: +92 309 8183945</span>
            </a>
            ...
            >
              ...
              <span className="text-lg font-sm text-white">Email: muka654r@gmail.com</span>
            </a>
            ...
            >
              ...
              <span className="text-lg font-sm text-white">GitHub: Mukarram685</span>
            </a>
            ...
            >
              ...
              <span className="text-lg font-sm text-white">LinkedIn: Your Profile</span>
            </a>
          </div>
        </div>


        <div className="flex-1 bg-gray-900 border border-gray-700 rounded-2xl shadow-xl md:p-6 backdrop-blur-lg">
          <ContactForm />
        </div>
